...
- Free Report: light professional theme, Property Score 0-100 gauge (SVG ring combining 12+ hazard factors — heritage/character are planning overlays, score-neutral), value-driven copy, Street View image, ICSEA scores on school cards, suburb stats timestamp, paid tier CTA, Inter font, responsive. Flood section leads with colour-coded risk headline (High/Medium/Low/Very Low) + plain-English summary paragraph. Australian language alignment (Suburb not Neighbourhood for non-planning terms). Planning Assessment framing (not "risk categories"). Google Geocoding spatial fallback for unit/apartment addresses.
